...
export function AppLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <div className="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 group">
            ...
            <div className="leading-tight">
              <div className="font-display text-sm font-semibold tracking-tight">KubeGraf</div>
              <div className="text-[10px] uppercase tracking-[0.18em] text-white/40">Internal Time Sheet</div>
            </div>
          </Link>
      ...
      <footer className="border-t border-white/5 py-6 text-center text-[11px] text-white/35">
